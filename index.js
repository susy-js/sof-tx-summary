...
const createRpcVm = require('sophonjs-vm/dist/hooked').fromSusyWebProvider
const sofUtil = require('sophonjs-util')
// using local copy pending https://octonion.institute/susy-js/sophonjs-block/pull/24
const materializeBlock = require('./materialize-blocks')
// const materializeBlock = require('sophonjs-block/from-rpc')
...
function createVmTraceStream(provider, txHash){
  ...
  const query = new SofQuery(provider)
